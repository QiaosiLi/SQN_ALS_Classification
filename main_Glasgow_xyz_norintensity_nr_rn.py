...
class Glasgow:
    def __init__(self):
        ...
        self.input_colors = {'training': [], 'validation': []}  # input attributes
...
if __name__ == '__main__':
    ...
    if Mode == 'train':
        ...
        snap_path = '/models/glasgow_xyz_norintensity_nr_rn/snapshots'  # XYZ+ NorInt, RN, NR,  todo: replace the path of pretrain model here
